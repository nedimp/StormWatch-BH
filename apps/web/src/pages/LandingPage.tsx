...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 overflow-x-hidden pb-16 sm:pb-0" style={{ paddingBottom: 'calc(4rem + env(safe-area-inset-bottom))' }}>
      ...
      {liveStats.length > 0 && (
        <section className="border-y border-slate-100 bg-slate-50 px-6 py-5">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {liveStats.map((s) => (
              <div key={s.stationId} className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 shadow-sm">
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-slate-400 text-sm">Arhitektura za praćenje nevremena — od mjerenja do upozorenja</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map(({ Icon, color, title, desc }) => (
              <div key={title} className="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md hover:border-slate-300">
                <div className="mb-4 flex h-9 w-9 items-center justify-center rounded-lg" style={{ backgroundColor: color + '15' }}>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={key} className="flex flex-col items-center gap-2 rounded-xl border bg-white p-4 shadow-sm"
